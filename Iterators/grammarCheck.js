...
//MApping through an array and replacing misspeled word
...
//Finding index of a certain word
...
//Check for words smaller than 10 characters - returning true if all words are less than 10 characters, otherwise false
...
//If there is a word bigger than 10 char, filter it and return it
const check = storyWords.filter(word => {
  if(word.length > 10) {
    return word
  }
})
